...
window.Switch = Backbone.Model.extend({
    ...
    initialize:function () {
        ...
        $.ajax({
            url:hackBase + "/wm/core/switch/" + self.id + '/desc/json?appid=1&appkey=1',
            dataType:"json",
        ...
        $.ajax({
            url:hackBase + "/wm/core/switch/" + self.id + '/aggregate/json?appid=1&appkey=1',
            dataType:"json",
            success:function (data) {
    ...
    loadPorts:function () {
        ...
        $.when($.ajax({
            url:hackBase + "/wm/core/switch/" + self.id + '/port/json?appid=1&appkey=1',
            dataType:"json",
            success:function (data) {
        ...
        $.ajax({
            url:hackBase + "/wm/core/switch/" + self.id + '/features/json?appid=1&appkey=1',
            dataType:"json",
            success:function (data) {
    ...
    loadFlows:function () {
        ...
        $.ajax({
            url:hackBase + "/wm/core/switch/" + self.id + '/flow/json?appid=1&appkey=1',
            dataType:"json",
            success:function (data) {
...
window.SwitchCollection = Backbone.Collection.extend({
    ...
    fetch:function () {
        ...
        $.ajax({
            url:hackBase + "/wm/core/controller/switches/json?appid=1&appkey=1",
            dataType:"json",
            success:function (data) {
