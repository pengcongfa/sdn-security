...
public class RouteResource extends ServerResource {
    ...
    public List<NodePortTuple> retrieve() {
        ...
        Route result = routing.getRoute(appId,appkey,longSrcDpid, shortSrcPort, longDstDpid, shortDstPort, 0);
        
        if (result!=null) {
            return routing.getRoute(appId,appkey,longSrcDpid, shortSrcPort, longDstDpid, shortDstPort, 0).getPath();
        }
        else {
