...
public class StaticFlowEntryPusherResource extends ServerResource {
    ...
    public String store(String fmJson) {
        ...
        try {
            ...
            storageSource.insertRowAsync(appId,appkey,StaticFlowEntryPusher.TABLE_NAME, rowValues);
    ...
    public String del(String fmJson) {
        ...
        storageSource.deleteRowAsync(appId,appkey,StaticFlowEntryPusher.TABLE_NAME, fmName);
