...
public class StaticFlowEntryPusher
    ...
    public void addFlow(String name, OFFlowMod fm, String swDpid) {
        ...
        storageSource.insertRowAsync("1","1",TABLE_NAME, fmMap);
    }

    @Override
    public void deleteFlow(String name) {
        storageSource.deleteRowAsync("1","1",TABLE_NAME, name);
    }
    ...
    */
	...
	@Override
	public Map<String, Map<String, OFFlowMod>> getFlows(String appId, String appKey) {
		// TODO Auto-generated method stub
		if(appId.equals("1")){
	        ...
	        if(accessCheck.appAuthentication(appId, appKey)){
	            if(accessCheck.appPermissionSetFinder(appId, PermissionType.read_all_flow)){
	            	 if(xacmlCtr.getXacmlEvaluateResult(appId)){
	            		 return entriesFromStorage;
	                      ...
	                      log.info("---------应用ID："+appId+"-------权限检查失败：无 read_all_flow 权限");
	             	 }
	           }
	          else{
	...
	@Override
	public Map<String, OFFlowMod> getFlows(String appId, String appKey, String dpid) {
		// TODO Auto-generated method stub
		if(appId.equals("1")){
