...
public class AllSwitchStatisticsResource extends SwitchResourceBase {
    ...
    public Map<String, Object> retrieve() {
        ...
        return retrieveInternal(appId,appkey,statType);
    }

    public Map<String, Object> retrieveInternal(String appId,String appKey,String statType) {
        ...
        for (Long l : switchDpids) {
            t = new GetConcurrentStatsThread(appId,appKey,l, rType, type);
            activeThreads.add(t);
            t.start();
        }
    ...
    protected class GetConcurrentStatsThread extends Thread {
        ...
        public GetConcurrentStatsThread(String appId,String appKey,long switchId, REQUESTTYPE requestType, OFStatisticsType statType) {
        ...
        public void run() {
            if ((requestType == REQUESTTYPE.OFSTATS) && (statType != null)) {
                switchReply = getSwitchStatistics(appId,appKey,switchId, statType);
