...
public class LoadBalancerTest extends FloodlightTestCase {
    ...
    public void testTwoSubsequentIcmpRequests() throws Exception {
     ...
     expect(routingEngine.getRoute("1","1",1L, (short)1, 1L, (short)3, 0)).andReturn(route1).atLeastOnce();
     ...
     expect(routingEngine.getRoute("1","1",1L, (short)3, 1L, (short)1, 0)).andReturn(route2).atLeastOnce();
     ...
     expect(routingEngine.getRoute("1","1",1L, (short)2, 1L, (short)4, 0)).andReturn(route3).atLeastOnce();
     ...
     expect(routingEngine.getRoute("1","1",1L, (short)4, 1L, (short)2, 0)).andReturn(route4).atLeastOnce();
     ...
     Map<String, OFFlowMod> map = sfp.getFlows("1","1","00:00:00:00:00:00:00:01");
