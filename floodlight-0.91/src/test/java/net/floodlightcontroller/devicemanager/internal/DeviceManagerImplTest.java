...
public class DeviceManagerImplTest extends FloodlightTestCase {
    ...
    public void testPacketInBasic() throws Exception {
        ...
        Iterator<? extends IDevice> dstiter =
                deviceManager.queryDevices("1","1",null, null, ipaddr,
                        null, null);
        if (dstiter.hasNext()) {
    ...
    protected void doTestDeviceQuery() throws Exception {
        ...
        Iterator<? extends IDevice> iter =
                deviceManager.queryDevices("1","1",null, (short)1, 1, null, null);
        int count = 0;
        while (iter.hasNext()) {
            count += 1;
            d = iter.next();
        ...
        iter = deviceManager.queryDevices("1","1",null, (short)3, 3, null, null);
        count = 0;
        while (iter.hasNext()) {
            count += 1;
            d = iter.next();
        ...
        iter = deviceManager.queryDevices("1","1",null, (short)1, 3, null, null);
        count = 0;
        while (iter.hasNext()) {
            count += 1;
            iter.next();
        ...
        Device d5 = deviceManager.learnDeviceByEntity(entity5);
        iter = deviceManager.queryDevices("1","1",null, (short)4, 3, null, null);
        count = 0;
        ...
        iter = deviceManager.queryDevices("1","1",1L, null, null, null, null);
        count = 0;
    ...
    private IDevice getSingleDeviceFromDeviceManager(long mac) {
        Iterator<? extends IDevice> diter =
                deviceManager.queryDevices("1","1",mac, null, null, null, null);
    ...
    public void testToMaster() throws Exception {
        ...
        Iterator<? extends IDevice> diter =
                deviceManager.queryDevices("1","1",3L, null, null, null, null);
        ...
        assertFalse("Device3 not is still in the store. Entries in store: "
                    + entries, found);
        // make sure it's not in DevManager
        diter = deviceManager.queryDevices("1","1",3L, null, null, null, null);
        assertFalse("Device3 found in DeviceManager. Should be there",
                    diter.hasNext());
    }
