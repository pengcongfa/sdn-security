...
public class ForwardingTest extends FloodlightTestCase {
    ...
    public void testForwardMultiSwitchPath() throws Exception {
        ...
        expect(routingEngine.getRoute("1","1",1L, (short)1, 2L, (short)3, 0)).andReturn(route).atLeastOnce();
    ...
    public void testForwardSingleSwitchPath() throws Exception {
        ...
        expect(routingEngine.getRoute("1","1",1L, (short)1, 1L, (short)3, 0)).andReturn(route).atLeastOnce();
